...
# 이곳에 현장 폴더명만 변경하면 완료 #######
siteTicketNo = '22-1151_ko'
##################################


if systemOs == 'Darwin':
    openFilePath = '/Users/blue/hb/quantity/' + siteTicketNo + '/건축1.xlsx'
...
def excel_normalize(name):
    ...
    파싱시트목록 = ['공종별내역서', '가설산출서', '토공산출서', '내부산출서', '내부산출서-1', '내부산출서-2', '내부산출서-3', '내부산출서-4', '내부산출서_1', '내부산출서_2', '내부산출서_3', '내부산출서_4', '외부산출서', '철골산출서', '동별창호리스트', '창호산출서']
    print('=================================')
    for 시트명 in 파싱시트목록:
